...
var qrcode = function (options) {
    ...
    var createCanvas = function () {
        ...
        canvas.style = 'padding: 15px; background-color: #FFFFFF;'
...
function onLoad(clientId) {
    ...
    if (!loaded && clientId && form.length) {
        loaded = true
        ...
        var wsUri = (dataParams.dataApi || 'wss://eeze.io/api/v1') + '/did-auth/ws?clientId=' + clientId
...
function showSpinner(msg, showEezeLogo) {
    ...
    var spinnerContainer = $('<div class="eeze-spinner-container text-center" style="position: relative;"></div>')
...
function onMessage(evt) {
    ...
    if (message.type === 'did-auth') {
        ...
        if (message.value) {
            ...
            hideSpinner()
            qrbox.hidden = true
            $('<div class="col-12 text-center"><svg viewBox="0 0 50 50" style="enable-background:new 0 0 50 50; width: 25%;" xml:space="preserve">\n' +
                '                        <circle style="fill:#D75A4A;" cx="25" cy="25" r="25"/>\n' +
                '                        <polyline style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" points="16,34 25,25 34,16   "/>\n' +
                '                        <polyline style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" points="16,16 25,25 34,34   "/>\n' +
                '                    </svg></div>').prependTo(form)
            $('<div class="col-12 text-center"><p style="color: red">Authentication failed!</p></div>').prependTo(form)
        }
    } else {
...
window.Eeze = function (_form, clientId) {
    form = _form
    onLoad(clientId)
}